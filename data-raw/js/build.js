...
// runtime (mosaic-spec + mosaic-core + vgplot + duckdb-wasm's own JS API --
...
const result = await build({
  ...
  banner: {
    js:
      ...
      `// Bundles @uwdata/mosaic-spec@${MOSAIC_VERSION}, @uwdata/mosaic-core@${MOSAIC_VERSION}, @uwdata/vgplot@${MOSAIC_VERSION},\n` +
