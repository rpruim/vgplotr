...
# Set to "iframe" (before child-including this file) to embed live
# widgets via <iframe> instead of static screenshots -- see
# pkgdown/index.Rmd, which renders this same content for the pkgdown
# home page.
if (!exists("vg_render_mode")) vg_render_mode <- "auto"
```
...
capabilities of vgplotr. (Live interaction not available on GitHub, see
