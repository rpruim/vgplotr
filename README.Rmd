...
# Set to TRUE (before child-including this file) to embed live widgets via
# <iframe> instead of static screenshots -- see pkgdown/index.Rmd, which
# renders this same content for the pkgdown home page.
if (!exists("vg_iframe_mode")) vg_iframe_mode <- FALSE
```
